...
export const AnimeTypeToStr = (type: AnimeType): string => {
  switch (type) {
    case AnimeType.tv:
      return 'TV';
    case AnimeType.ova:
...
export const AnimeStatusToStr = (status: AnimeStatus): string => {
  switch (status) {
...
export const UserAnimeStatusStr = (status: UserAnimeStatus): string => {
  switch (status) {
...
export const AnimeRelationToStr = (relation: AnimeRelation): string => {
  switch (relation) {
...
export const SeasonToStr = (season: Season): string => {
  switch (season) {
    case Season.winter:
      return 'Winter';
    case Season.spring:
...
export const DayToStr = (day: Day): string => {
  switch (day) {
    case Day.monday:
      return 'Monday';
    case Day.tuesday:
...
export const AnimeSourceToStr = (source: AnimeSource): string => {
  switch (source) {
